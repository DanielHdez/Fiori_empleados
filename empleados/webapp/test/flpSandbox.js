		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Empleados",
									"targetURL": "#dhlempleados-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dhlempleados-display": {
								"semanticObject": "dhlempleados",
								"action": "display",
								"description": "Mi aplicacion de empleados ",
								"title": "Empleados",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dhl.empleados",
									"url": sap.ui.require.toUrl("dhl/empleados")
								}
							}
						}
					}
